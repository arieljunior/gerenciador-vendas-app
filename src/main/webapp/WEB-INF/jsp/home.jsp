...
<body>
		...
		<div class="container-fluid">
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link"
					href="/vestimenta/lista">Vestimentas</a></li>
				<li class="nav-item"><a class="nav-link"
					href="/bebida/lista">Bebidas</a></li>
			</ul>
	...
	<div class="container mt-3">
		...
		<span class="badge rounded-pill bg-primary">Vendedor:
			...
			${qtdeProduto}</span> <span class="badge rounded-pill bg-success">Vestimenta:
			${qtdeVestimenta}</span> <span class="badge rounded-pill bg-danger">Bebida:
			${qtdeBebida}</span>

		<c:if test="${not empty listagem}">
			<h2>Gerenciador Vendas App</h2>
